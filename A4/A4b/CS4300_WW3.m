function [scores,trace] = CS4300_WW3(max_steps,f_name)
...
scores(4).board = board4;
scores(4).score = score;
scores(4).trace = trace;
...
board5 = [0,0,0,0;...
          ...
          0,0,1,2;...
          0,0,3,0];
[score,trace] = CS4300_WW1(max_steps,f_name,board5);
scores(5).board = board5;
scores(5).score = score;
scores(5).trace = trace;
